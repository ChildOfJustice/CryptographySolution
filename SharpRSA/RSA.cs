...
namespace SharpRSA
{
    public class RSA
    {
        ...
        public static KeyPair GenerateKeyPair(int bitlength)
        {
            ...
            byte[] randomBytes = new byte[bitlength / 2];
            ...
            BigInteger x1;
            BigInteger y1;
            ExtendedEuclideanAlgorithm(Constants.e, phi, out x1, out y1);
            d = x1;
            while(d < 0)
                d += phi;
        ...
        public static BigInteger EncryptOneByte(byte mToPow, Key public_key)
        {
            BigInteger exp = public_key.e;
            BigInteger modN = public_key.n;
        ...
        public static byte DecryptOneByte(BigInteger c, Key private_key)
        {
            BigInteger cToPow = c;
            BigInteger exp = private_key.d;
            BigInteger modN = private_key.n;
